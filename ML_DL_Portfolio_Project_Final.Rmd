...
<p style = "color:#082C6F; font-size: 20px !important; font-family: Arial;text-indent: 25px">
Deep Learning, a subset of Machine Learning, is distinguished by its use of multi-layered neural networks to learn data representations at various levels of abstraction. Deep Learning is commonly known for it boosted performances, so in the fourth section, I will measure Deep Learning's performance against all other ML methods used in the study. Finally, in the last section, I will repeat the entire process using Boston housing dataset to test the generalizability of the methodological approach demonstrated in this project.</p>
